    ...
    <template v-else>
      ...
      <div :class="topRowClass">
        <div :class="metaFieldClass">
          ...
          <MpTextlink as="button" variant="primary" @click="onAction('view-vendor')">{{ delivery.vendorName }}</MpTextlink>
        </div>
      ...
      <div :class="metaGridClass">
        ...
        <div :class="metaColClass">
          ...
          <div v-if="linkedOrder" :class="metaFieldClass">
            ...
            <MpTextlink as="button" variant="primary" @click="navigateTo(`/purchase/order/${linkedOrder!.id}`)">{{ linkedOrder.number }}</MpTextlink>
          </div>
          <div :class="metaFieldClass">
